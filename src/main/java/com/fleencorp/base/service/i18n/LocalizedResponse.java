package com.fleencorp.base.service.i18n;
...
public class LocalizedResponse {
  ...
  /**
   * Updates the message in the provided {@link ApiResponse} with the localized message corresponding to its message key.
   *
   * <p>This method retrieves the localized message for the given {@link ApiResponse} based on its message key and
   * updates the response's message field with this localized message. If the response is {@code null}, the method
   * returns {@code null}.</p>
   *
   * @param response the {@link ApiResponse} object to be updated with the localized message.
   * @param <T> the type of the data contained in the {@link ApiResponse}.
   * @return the updated {@link ApiResponse} with the localized message, or {@code null} if the input response was {@code null}.
   */
